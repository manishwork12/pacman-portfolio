...
const socialLinks = [
  { name: 'GitHub', icon: Github, url: '#', color: 'hover:text-foreground' },
  { name: 'LinkedIn', icon: Linkedin, url: '#', color: 'hover:text-secondary' },
  { name: 'Portfolio', icon: Globe, url: '#', color: 'hover:text-green-400' },
  { name: 'LeetCode', icon: Code2, url: '#', color: 'hover:text-primary' },
];
...
export const ContactSection = ({ onClose }: ContactSectionProps) => {
  ...
  return (
    <div className="fixed inset-0 glass-overlay z-50 flex items-center justify-center p-4 animate-fade-in">
      <div className="glass-card max-w-lg w-full max-h-[90vh] overflow-auto border-4 border-orange-400 shadow-[0_0_30px_rgba(251,146,60,0.3)]">
        ...
        <div className="p-6">
          ...
          <div className="flex justify-center gap-4 mb-6">
            {socialLinks.map((link) => (
              <a
                ...
                className={`p-3 glass-button rounded-full text-muted-foreground transition-all hover:scale-110 ${link.color}`}
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                ...
                <Input
                  ...
                  className="glass-button border-border/50 text-foreground placeholder:text-muted-foreground"
                  required
                />
              </div>
              <div>
            ...
            <div>
              <Label htmlFor="subject" className="text-foreground">Regarding</Label>
              <Input
                id="subject"
            ...
            <div>
              ...
              <Textarea
                ...
                className="glass-button border-border/50 text-foreground placeholder:text-muted-foreground min-h-[100px]"
                required
              />
            </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="collaboration" className="text-muted-foreground text-sm cursor-pointer">
